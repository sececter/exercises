                ...
                uchar4* const h_blendedImg) //OUT
{
	...
	checkCudaErrors(cudaMemcpy((uchar4 *)d_sourceImg, (uchar4 *)h_sourceImg, sizeSource*sizeof(uchar4), cudaMemcpyHostToDevice));
	checkCudaErrors(cudaMemcpy((uchar4 *)d_destImg, (uchar4 *)h_destImg, sizeSource*sizeof(uchar4), cudaMemcpyHostToDevice));
	...
	checkCudaErrors(cudaMemcpy((uchar4 *)d_blendedImg, (uchar4 *)h_destImg, sizeSource*sizeof(uchar4), cudaMemcpyHostToDevice));
	...
	checkCudaErrors(cudaMemcpy((uchar4 *)h_blendedImg, (uchar4 *)d_blendedImg, sizeSource*sizeof(uchar4), cudaMemcpyDeviceToHost));
}
