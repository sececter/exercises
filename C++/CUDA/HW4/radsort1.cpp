								...
								unsigned int* d_histo, unsigned int* d_scan, unsigned int numBins, unsigned int i)
{
	...
	unsigned int pos = threadIdx.x + d_scan[first_bin_in_block_histo_scan_idx];
               ...
               const size_t numElems)
{
	...
	{		
		...
		write<<<numBlocks, elemsPerBlock>>>(d_vals_src, d_pos_src, d_vals_dst, d_pos_dst, d_histo, d_scan, numBins, i);
